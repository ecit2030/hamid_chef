<template>
  <section id="why-us" class="py-16 lg:py-24 bg-gray-50">
    <div class="container mx-auto px-4 lg:px-8 flex flex-col items-center">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 w-full max-w-6xl mx-auto">
        <div
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-5xl mx-auto">
