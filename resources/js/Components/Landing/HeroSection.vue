<template>
  ...
  >
    ...
    <div class="container relative z-10 mx-auto px-4 lg:px-8 py-24 lg:py-32 flex flex-col items-start text-left">
      <div class="max-w-3xl w-full">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-16 pt-16 border-t border-white/20 w-full max-w-4xl">
          <div v-for="stat in stats" :key="stat.label_ar" class="text-left">
