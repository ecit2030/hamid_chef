<template>
    <AdminLayout>
        <PageBreadcrumb :pageTitle="$t('discountCodes.edit')" />
...
const form = useForm({
    ...
    min_order_amount: props.code.min_order_amount,
    max_discount_amount: props.code.max_discount_amount,
    start_date: props.code.start_date,
    end_date: props.code.end_date,
    usage_limit: props.code.usage_limit,
    per_user_limit: props.code.per_user_limit,
