            ...
            <div>
              <div class="mb-5 sm:mb-8">
                <div class="flex items-center gap-3 mb-4">
                  <div class="flex items-center justify-center w-12 h-12 rounded-full bg-brand-100 dark:bg-brand-900/30">
                  ...
                  <div>
                    <h1 class="font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">
                      {{ t('chef.auth.login.title') }}
                    </h1>
                    <p class="text-sm text-brand-600 dark:text-brand-400">
                      {{ t('chef.auth.login.chefPanel') }}
                    </p>
                  </div>
                </div>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  {{ t('chef.auth.login.subtitle') }}
                </p>
              </div>
              <div>
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <Link
                        :href="route('chef.password.request')"
